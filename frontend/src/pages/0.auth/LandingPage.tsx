...
const featureCards = [
  ["AI 건강 예측", "당뇨·고혈압·만성신장질환 위험 신호를 사전에 확인합니다.", "green", icons.aiRisk],
  ["실시간 모니터링", "혈압, 혈당 등 건강 지표를 추적하고 이상 징후를 알려드립니다.", "yellow", icons.bloodPressure],
  ["생활습관 챌린지", "걷기, 식단, 수면 등 맞춤형 챌린지로 건강 습관을 형성합니다.", "blue", icons.healthChallenge],
  ["전문의 연계", "위험 신호가 감지되면 전문의 상담을 권장합니다.", "pink", icons.healthGuide],
  ["개인 맞춤 대시보드", "나의 건강 데이터를 한눈에 볼 수 있는 대시보드를 제공합니다.", "violet", icons.healthGuide],
  ["복약·건강관리", "복약 여부와 건강검진 정보를 조언 컨텍스트로 활용합니다.", "mint", icons.linkValidTime],
];
...
const challengeItems = [
  ["매일 걷기 6,000보", "꾸준한 걷기 운동으로 심폐 기능을 향상시키세요.", "green", icons.walking],
  ["저염 식단 챌린지", "나트륨 섭취를 줄여 혈압을 자연스럽게 조절합니다.", "yellow", icons.lowSaltDiet],
  ["7시간 수면 확보", "규칙적인 수면 습관으로 신체 회복력을 높이세요.", "blue", icons.sleepSevenHours],
  ["혈압 매일 측정", "일관된 혈압 측정으로 건강 변화를 놓치지 마세요.", "pink", icons.bloodPressure],
];
    ...
    <>
      ...
      <section className="landing-section" id="features">
        ...
        <div className="feature-grid">
          {featureCards.map(([title, description, tone, icon]) => (
      ...
      <section className="landing-section challenge-section" id="challenge">
        ...
        <div className="challenge-showcase">
          <div className="challenge-list">
            {challengeItems.map(([title, description, tone, icon]) => (
